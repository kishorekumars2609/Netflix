...
//                   autoComplete="current-password"
//                 />
//                 <button className="bg-red-600 py-3 my-6 rounded font-bolt ">
//                   Sign Up
//                 </button>
//                 <div className="flex justify-between items-centre text-sm text-gray-600">
//                   <p>
//                     {" "}
